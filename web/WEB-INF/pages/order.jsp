...
<div class="wrapper">
    ...
    <div class="g-main">
        <div class="m-jumbotron">
            <div class="tit">在线租房</div>
            <div class="sub-tit">数万线下门店 · 快速全城推广 · 专业经纪人服务</div>
        </div>
        <div class="m-form">
            <form action="${pageContext.request.contextPath }/mineServlet?method=toorder&fangide=${fandidop}" method="post">
                <div class="form-box">
                    <div class="box-l m-entry" id="model">
                            <dl>
                                <dt>入住日期</dt>
                                <dd class="wrap-sug">
                                    <div class="u-sug" id="u-sug">
                                        <input class="sugInput" name="data" type="text" autocomplete="off" placeholder="请输入入住日期"/>
                                    </div>
                                </dd>
                            </dl>
                            <dl>
                                ...
                                <dd class="wrap-sug">
                                    <div class="u-sug" >
                                        <input class="sugInput" type="hidden" autocomplete="off" value="${fg.rent}" id="zujin"/>
                                        <input onkeyup="jisuan();" class="sugInput" name="time" type="number" autocomplete="off" placeholder="1" id="computerNumber"/>
                                    </div>
                                </dd>
                            </dl>
                        <dl>
                            ...
                            <dd class="wrap-sug">
                                <div class="u-sug" >
                                    <input class="sugInput" name="qian" type="number" autocomplete="off"  id="zomoney"/>
                                </div>
                            </dd>
                        </dl>
                    </div>
                ...
                <div class="m-submit">
                    <div class="wrap">
                        <div class="btn-submit">
                            <button style="background-color: #3072F6">提交</button>
                        </div>
                    </div>
                </div>
            </form>
...
<script>
    function jisuan(){
        var text1=document.getElementById("zujin").value;
        var text2=document.getElementById("computerNumber").value;
        document.getElementById("zomoney").value=parseFloat(text1)*parseFloat(text2);
    }
