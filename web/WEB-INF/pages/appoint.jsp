...
<div class="wrapper">
    ...
    <div class="header ">
        <ul class="header__wrapper w1150 clear typeUserInfo" id="top">
            <li class="header__item fl" >
                <a href="//cd.ke.com" target="_blank">首页</a>
            </li>
            <li class="header__item fl" >
                <a href="//cd.ke.com/ershoufang/" target="_blank">二手房</a>
            </li>
            <li class="header__item fl" >
                <a href="//cd.fang.ke.com/loupan/" target="_blank">新房</a>
            </li>
            ...
            <li class="header__item fl" >
                <a href="//cd.ke.com/xiaoqu/" target="_blank">小区</a>
            </li>
            <li class="header__item fl" >
                <a href="//news.ke.com/cd/baike/" target="_blank">百科</a>
            </li>
            <li class="header__item fl" >
                <a href="//cd.ke.com/fangjia/" target="_blank">房价</a>
            </li>
            <li class="header__item fl publish-house" data-event_id="20383">
                <a href="//cd.ke.com/yezhu/maifang/" target="_blank">发布房源</a>
            </li>
            <li class="header__item fl download">
                <a href="javascript:;" target="_blank">下载APP</a>
                <div class="download__box">
                    <img src="https://s1.ljcdn.com/matrix_pc/dist/pc/src/resource/img/getDownloadQr.png?_v=20201214143047025" alt="下载贝壳APP">
                </div>
            </li>
            <li class="header__item fl">
    ...
    <div class="header-top">
        <div class="wrap">
            <a class="logo" href="https://cd.ke.com/yezhu/maifang/"></a>
            <div class="app">
                    ...
                    <dl>
                        ...
                        <dd class="wrap-sug">
                            <div class="u-sug" id="u-sug">
                                <input class="sugInput" name="resblock" type="text" autocomplete="off" placeholder="请输入电话号码"/>
                            </div>
                        </dd>
                    </dl>
                    <dl>
                        ...
                        <dd class="wrap-sug">
                            <div class="u-sug" >
                                <input class="sugInput" name="resblock" type="text" autocomplete="off" placeholder="请输入看房日期"/>
                            </div>
                        </dd>
                    </dl>
                    <dl>
...
<div class="footer">
    <div class="footer__wrapper w1150">
        ...
        <div class="footer__bottom">
            <p>天津小屋信息科技有限公司 | <a style="color: #B7BBC3" href="http://beian.miit.gov.cn">津ICP备18000836号</a> |  &copy; Copyright &copy; 2010-2020 ke.com版权所有</p>
