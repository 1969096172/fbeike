...
<%@ page import="com.li.ers.model.Housetype" %>
<%@ page import="java.util.List" %>
<%@ page import="com.li.ers.model.Area" %><%--
...
<div class="wrapper">
    ...
    <div class="g-main">
        <div class="m-jumbotron">
            ...
            <div class="sub-tit"> <a href="${pageContext.request.contextPath}/homeServlet?method=goad">返回--</a> 数万线下门店 · 快速全城推广 · 专业经纪人服务</div>
        </div>
        <div class="m-form">
            <form action="${pageContext.request.contextPath}/mineServlet?method=upfang" method="post">
                <div class="form-box">
                    <div class="box-l m-entry">
                        <dl>
                            ...
                            <dd class="wrap-sug">
                                <div class="u-sug">
                                    <select id="sel" class="u-select u-select-build" style="border: 1px solid #FFFFFF;">
                                        <%
                                            MineService mineService = new MineService();
                                            List<Area> areaList = mineService.getarea();
                                            for (Area area: areaList){
                                        %>
                                        <option value="<%=area.getAreaid()%>" ><%=area.getAreaname()%></option>
                                        <%}%>
                                    </select>
                                    <input name="areaidx" type="hidden" id="ccid" value=""/>
                        ...
                        <dl>
                            ...
                            <dd class="wrap-sug">
                                <div class="u-sug">
                                    <input class="sugInput" name="xiaoqu" type="text" autocomplete="off" placeholder="请输入小区名"/>
                                </div>
                            </dd>
                        </dl>
                        <dl>
                            <dt>户型</dt>
                            <dd>
                                <select id="kin" class="u-select u-select-build" style="border: 1px solid #FFFFFF;">
                                    <%
                                        List<Housetype> kindlist = mineService.getkind();
                                        for (Housetype kind: kindlist){
                                    %>
                                    <option  value="<%=kind.getTypeid()%>" ><%=kind.getTypename()%></option>
                                    <%}%>
                                </select>
                                <input type="hidden" value="" id="kind" name="kindidx">
                            </dd>
                        </dl>
                        <dl>
                            <dt>朝向</dt>
                            <dd class="wrap-sug">
                                <div class="u-sug">
                                    <input class="sugInput" name="chaoxiang" type="text" autocomplete="off" placeholder="请输入朝向"/>
                                </div>
                            </dd>
                        </dl>
                        <dl>
                            <dt>电梯</dt>
                            <dd>
                                <input type="text" value="" placeholder="有/无" name="dianti">
                            </dd>
                        </dl>
                        <dl>
                            <dt>楼层</dt>
                            <dd>
                                <div class="u-select u-select-build">
                                    <input placeholder="请输入楼层" name="building" maxlength="10" data-id="" class="u-select-selected" type="text" value="">
                        ...
                        <dl>
                            <dt>租金</dt>
                            <dd>
                                <input name="expectation_price" value="" type="text" placeholder="请输入租出的价格" autoComplete="off"
                                       style="width: 210px;"/>
                        ...
                        <dl>
                            <dt>出租方式</dt>
                            <dd>
                                <select id="fanshi" class="u-select u-select-build" style="border: 1px solid #FFFFFF;">
                                    <option value="整租">整租</option>
                                    <option value="合租">合租</option>
                                    <option value="其他">其他</option>
                                </select>
                                <input type="hidden" value="" id="fans" name="fangshi">
                        ...
                        <dl>
                            ...
                            <dd class="wrap-sug">
                                <div class="u-sug" id="u-sug">
                                    <input class="sugInput" name="zuqi" type="text" autocomplete="off" placeholder="请输入租期"/>
                                </div>
                            </dd>
                        </dl>
                        <dl>
                            ...
                            <dd>
                                <div class="u-select u-select-build">
                                    <input placeholder="请输入详细地址" name="addrdss" maxlength="10" data-id="" class="u-select-selected" type="text" value="">
                                    <ul class="u-select-options hide"></ul>
                                </div>
                            </dd>
                        </dl>
...
<script>
    ...
    //添加点击事件
    kin.onclick = function () {
        //获取option标签的下标
        var ind = kin.selectedIndex
        //获取option的value值
        var val = kin[ind].value
        // console.log(val)
        document.getElementById("kind").value=val;
    }
    //获取select标签
    var fanshi = document.querySelector('#fanshi')
    //添加点击事件
    diti.onclick = function () {
        //获取option标签的下标
        var ind = fanshi.selectedIndex
        //获取option的value值
        var val = fanshi[ind].value
        // console.log(val)
        document.getElementById("fans").value=val;
    }
</script>
